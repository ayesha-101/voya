...
export const site = {
  ...
  description:
    "المتجر الرسمي لمنتجات ڤويا الأصلية — عناية عضوية بالبشرة والجسم مستخلصة من الأعشاب البحرية المحصودة يدويًا.",
  currency: "AED",
  locale: "ar-AE",
  country: "الإمارات العربية المتحدة",
  whatsapp: "971500000000",
  phone: "+971 50 000 0000",
  email: "info@byvoyastore.com",
  ...
  social: [
    ...
    { label: "واتساب", href: "https://wa.me/971500000000", icon: "whatsapp" },
  ],
} as const;
