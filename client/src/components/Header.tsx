      ...
      <div className="mx-auto flex h-18 max-w-7xl items-center gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="ms-auto flex items-center gap-2 lg:ms-0">
          <Link
            ...
            className="grid h-11 w-11 place-items-center rounded-full border border-sand-300 text-sea-700 transition hover:border-sea-400 hover:bg-sand-50"
          ...
          <Link
            href="/cart"
            className="relative grid h-11 w-11 place-items-center rounded-full bg-sea-700 text-white transition hover:bg-sea-800"
        ...
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="absolute inset-y-0 end-0 flex w-[86%] max-w-sm flex-col bg-white shadow-2xl">
            ...
            <ul className="flex-1 overflow-y-auto p-2">
              ...
              <li className="mt-2 border-t border-sand-200 pt-2">
                <Link
                  href={accountHref(user)}
                  onClick={() => setOpen(false)}
                  className="block rounded-xl px-4 py-3 font-bold text-sea-700 transition hover:bg-sand-100"
                >
                  {authReady && user
                    ? user.role === "admin"
                      ? "لوحة التحكّم"
