            ...
            <li key={o.reference} className="rounded-card border border-sand-200 bg-white p-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <select
                  ...
                  className="rounded-full border border-sand-300 bg-white px-3 py-2 text-[13px] font-bold outline-none focus:border-sea-400 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  className="rounded-full border border-sand-300 px-4 py-2 text-[13px] font-bold text-sea-700 transition hover:border-sea-400"
                >
              ...
              {expanded === o.reference && (
                <div className="mt-4 grid gap-4 border-t border-sand-100 pt-4 sm:grid-cols-2">
                  ...
                  <div className="text-sm">
                    ...
                    {o.shipping.notes && (
                      <p className="mt-2 rounded-xl bg-sand-50 p-2.5 text-xs text-ink">
