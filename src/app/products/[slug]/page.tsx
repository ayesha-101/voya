...
import { getCategory, getProduct, products, related } from "@/data/products";
    ...
    <div className="mx-auto max-w-7xl px-6 py-8">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <ProductPurchasePanel slug={product.slug} stock={product.stock} />
          ...
          <details className="rounded-card border border-sand-200 p-5" open>
            ...
            <ul className="mt-4 flex flex-wrap gap-2">
              {product.ingredients.map((i) => (
                <li
                  key={i}
                  className="rounded-full bg-sand-100 px-3.5 py-1.5 text-[13px] text-ink"
                >
                  {i}
                </li>
              ))}
